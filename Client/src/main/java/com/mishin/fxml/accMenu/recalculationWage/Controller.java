package com.mishin.fxml.accMenu.recalculationWage;
        ...
        if(!workingDays.getText().equals("")) {
            if(Integer.valueOf(wasWorked.getText())<=31 && Integer.valueOf(wasWorked.getText())>0) {
                if (Integer.valueOf(workingDays.getText()) < Integer.valueOf(wasWorked.getText())) {
                    JOptionPane.showMessageDialog(null, "Количество учебных дней не может быть больше количества дней!");
                    wasWorked.setText("");
                }
            }
            else {
                JOptionPane.showMessageDialog(null, "Количество дней должно быть в диапозоне[0,365]!");
                wasWorked.setText("");
            }
        }
        else {
            JOptionPane.showMessageDialog(null, "Введите кол-во учебных дней!");
            wasWorked.setText("");
        }
    }
